// components/Dashboard/Pages/MountainTripTable/MountainTripTablePrivate.js
import React, { useState } from "react";

const MountainTripTableGathering = () => {
          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6">
                <h1 className="m-0">Gatheirng Kantor</h1>
              </div>
              <div className="col-sm-6">
                <ol className="breadcrumb float-sm-right">
                  ...
                  <li className="breadcrumb-item active">GatheringKantor</li>
                </ol>
              </div>
            </div>
          </div>
...
export default MountainTripTableGathering;
